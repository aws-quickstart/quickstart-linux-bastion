...
with. There is a shadow file containing a copy of `bastion.log` located in `/var/log/audit/audit.log`. 

If a malicious user does find the `bastion.log` file, somehow gains root privileges,
