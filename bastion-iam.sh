STACK_NAME="bastion-iam"
REGION="us-west-2"
CFN_TEMPLATE_URL="https://s3.amazonaws.com/lehto-bastion/templates/bastion-iam.yaml"
...
function usage() {
    ...
    echo " "
    echo "options:"
    echo -e "-r <region> \t Specify AWS region for the stack"
}
...
echo "This script will create global IAM resources for bastion hosts, executed in AWS region '${REGION}'"
